    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          ...
          <?php echo "<img src='".$avatar."' class='img-circle elevation-2' alt='User Image' style='width: 40px; height: 40px'>"; ?>
        </div>
        <div class="info">
          <A><?php
              echo $hoten;
          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-md-7">
                ...
                <div class="col-md-6 form-group">
                  <input type="button" onclick='themtaikhoan()' value="Thêm Tài Khoản" class="btn btn-primary">
                </div>
              </div>
            </div>
          </div>
